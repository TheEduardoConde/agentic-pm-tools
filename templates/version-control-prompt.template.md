# Version-Control Preparation Prompt

Prepare a version-control recommendation only. Do not commit, push, merge, rebase, force push, deploy, tag, or create a release without Eddie's explicit approval.
